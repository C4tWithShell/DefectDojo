...
env = environ.FileAwareEnv(
    ...
    DD_DATA_UPLOAD_MAX_MEMORY_SIZE=(int, 15728640),  # Max post size set to 15mb
...
HASHCODE_FIELDS_PER_SCANNER = {
    ...
    'Slither Scan': ['title', 'description',  'file_path'],
    'Xeol Scan': ['title', 'file_path'],
...
DEDUPLICATION_ALGORITHM_PER_PARSER = {
    ...
    'Xeol Scan': DEDUPE_ALGO_HASH_CODE,
